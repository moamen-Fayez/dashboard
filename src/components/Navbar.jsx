...
const NavBar = () => {
 const { activeMenu, setActiveMenu, isClicked, setIsClicked, handleClick, screenSize, setScreenSize, currentColor, handleNotification } = useStateContext();
 useEffect(() => {
      ...
      <TooltipComponent content='Profile' position='BottomCenter'>
        ...
        onClick={() => handleClick('userProfile')} >
          ...
          <p>
            ...
            <span className='text-gray-400 font-bold ml-1 text-14'>Moamen</span>
          </p>
